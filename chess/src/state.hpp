...
bool operator!=(const PLAYERTOMOVE& ptm, const Owner& o) {return !(ptm==o);}
bool operator==(const Owner& o, const PLAYERTOMOVE& ptm) {
    return (ptm == PLAYERTOMOVE::WHITE && o == Owner::WHITE) ||
      (ptm == PLAYERTOMOVE::BLACK && o == Owner::BLACK);
}
bool operator!=(const Owner& o, const PLAYERTOMOVE& ptm) {return !(o==ptm);} 
